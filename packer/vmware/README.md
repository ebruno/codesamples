...
packer can be installed using brew.
...
Instructions for installing packer for Linux can be found here: 
...
Variables:
	 ...
	 variable "esxi_server" {Warning: [WARN] 'vnc_over_websocket' enabled; other VNC configurations will be ignored.
		type      = string
